...
//sigue con seis letras y termina por tres dígitos o bien cuatro letras.
    let correcto = true;
    let normaCodTorneo = /^(SER|ES|DEBE|CAR)\d{3}[#$&%][a-zA-Z]{5}[a-zA-Z\d\/+]{6}[a-zA-Z]{6}(\d{3}|[a-zA-Z]{4})$/;
...
//20 caracteres.
    let correcto = true;
    let normaNombreTorneo = /^[a-zA-Z]{5}[a-zA-Z\d-|?¿]{9,20}[a-zA-Z\d.]{2}$/;
...
//entre 1890 y 2075.
    let correcto = true;
    let normaFechaCelebracion = /^((19|20)\d\d)-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/;
...
//entre 8 y 25 caracteres.
    let correcto = true;
    let normaCiudadTorneo = /^[a-zA-Z ]{8,25}$/;
...
//termina por cuatro caracteres que pueden ser letras o dígitos.
    let correcto = true;
    let normaCodigoCiudad = /^[a-zA-Z]{2}\d{3}(ARPA|DOM|DE|POR)[a-zA-Z]{5}[a-zA-Z\d]{4}$/;
...
//valores “USA”, “Inglaterra”, “Escocia”, “España” o “Japón”.
    let correcto = true;
    let normaPaisTorneo = /^(USA|Inglaterra|Escocia|España|Japón)$/;
...
//hasta dos decimales.
    let correcto = true;
    let normaCuantiaPremio = /^\d{1,7}(\.\d{1,2})?$/;
...
//caracteres.
    let correcto = true;
    let normaNombreMejor = /^[a-zA-Z ]{12,20}$/;
...
//215.
    let correcto = true;
    let normaNumeroGolpesMejor = /^\d{2,5}$/;
...
//que pueden ser letras, espacios o los caracteres “-“ y “º”.
    let correcto = true;
    let normaNombreUltimoGanador = /^[a-zA-Z]{3}[a-zA-Z -º]{11,17}[a-zA-Z]{5}$/;
...
//letras; a continuación va a tener 3 o 7 dígitos
    let correcto = true;
    let normaCodigoEmpresa = /^[a-zA-Z]{5,9}\d{3,7}$/;
